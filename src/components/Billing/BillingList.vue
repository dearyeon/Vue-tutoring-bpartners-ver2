<template>
	<div>
		<Header title="정기 결제 관리"
			...
			<span class="col-lg-12" style="display:flex;background-color:hotpink">
					<h3 class="col-lg-6">정기결제일시</h3>
					<h4 class="col-md-offset-2">{{ batch ? batch.charge_dt? moment(batch.charge_dt).format('YYYY-MM-DD HH:mm') : '-' : '-' }}</h4>
			</span>
		</Header>
